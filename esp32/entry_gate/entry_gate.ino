/*
 * Production ESP32 Entry Gate Firmware
...
void setup() {
    Serial.begin(115200);
    Serial.println("\n\n=================================");
    Serial.println("GYM ENTRY GATE - PRODUCTION v2.0");
    Serial.println("=================================\n");
...
void loop() {
    ...
    bool success = processEntry(rfidUID);
...
bool processEntry(String rfidUID) {
    HTTPClient http;
    http.setTimeout(API_TIMEOUT_MS);
    
    String url = String(SERVER_URL) + "?type=entry&rfid_uid=" + rfidUID + "&gate_id=" + GATE_ID;
    ...
    if (response.indexOf("\"success\":true") > 0 && 
        ...
        // Extract member name if available
    ...
    if (reasonStart > 0) {
        ...
        Serial.println("[ACCESS DENIED] Unknown reason");
    }
